    ...
    stage('Deploy') {
        ...
        try {
            ...
            sshagent(['ec2-key']) {
                ...
                // sh 'ssh -o StrictHostKeyChecking=no ubuntu@54.179.63.68 docker run --rm -v /home/ubuntu/submission-python-app/' + env.BUILD_ID + '/ bagaspm12/submission-python-app 'pyinstaller -F add2vals.py''    
            }
        }
        catch(Exception e) {
            echo e.getMessage()
